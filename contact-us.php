...
<header>
    ...
    <div class="off-screen-menu">
        <ul class = "sections">
            <li><a href="index.php"><img src="assets/icons/home.png"alt=""><span>Home</span></a></li>
            ...
            <li><a class = "active" href="#"><img src="assets\icons\contactUs.png"alt=""><span>Contact us</span></a></li>
        </ul>      
    </div>
    <nav>
        <div class="ham-menu">
